...
if _lang.startswith("fr"):
    ...
    T = {
        ...
        "results_max":  "{n} de {total} resultados — límite alcanzado",
        "no_results":   "Sin resultados.",
        "searching":    "Buscando…",
        "replacing":    "Reemplazando…",
        "previewing":   "Generando vista previa…",
        "replaced":     "{n} reemplazo(s) en {f} archivo(s) ✓",
        "preview_info": "{n} reemplazo(s) en {f} archivo(s) — pulse «Reemplazar todo» para aplicar",
        "open_file":    "Abrir archivo",
        "open_gedit":   "Abrir con Gedit",
        ...
        "col_match":    "Contenido",
        "error":        "Error: ",
        "empty_search": "Introduzca un texto para buscar.",
        "confirm_title":"Confirmar reemplazo",
        "confirm_body": "Esto modificará {f} archivo(s). Se creará una copia .bak. ¿Continuar?",
        "confirm_ok":   "Reemplazar",
        "confirm_cancel":"Cancelar",
        "backup_note":  "Copia .bak creada para cada archivo modificado.",
        "toggle_all":   "Marcar / desmarcar todo",
        "none_selected":"Ninguna línea seleccionada.",
    }
elif _lang.startswith("pt"):
    T = {
        "menu_label":   "Pesquisar nos arquivos",
        "title":        "Pesquisa de conteúdo",
        "tab_search":   "Pesquisar",
        "tab_replace":  "Pesquisar e substituir",
        "pattern":      "Texto para pesquisar…",
        "replace_with": "Substituir por…",
        "extensions":   "Extensões (ex.: py,txt,md — vazio = todas)",
        "recursive":    "Recursivo (subpastas)",
        ...
        "tool":         "Ferramenta:",
        "results":      "{n} resultado(s)",
        "results_max":  "{n} de {total} resultados — limite atingido",
        "no_results":   "Nenhum resultado.",
        "searching":    "Pesquisando…",
        "replacing":    "Substituindo…",
        "previewing":   "Gerando prévia…",
        "replaced":     "{n} substituição(ões) em {f} arquivo(s) ✓",
        "preview_info": "{n} substituição(ões) em {f} arquivo(s) — clique em “Substituir tudo” para aplicar",
        "open_file":    "Abrir arquivo",
        "open_gedit":   "Abrir com o Gedit",
        ...
        "col_match":    "Conteúdo",
        "error":        "Erro: ",
        "empty_search": "Digite um texto para pesquisar.",
        "confirm_title":"Confirmar substituição",
        "confirm_body": "Isso modificará {f} arquivo(s). Uma cópia .bak será criada. Continuar?",
        "confirm_ok":   "Substituir",
        "confirm_cancel":"Cancelar",
        "backup_note":  "Cópia .bak criada para cada arquivo modificado.",
        "toggle_all":   "Marcar / desmarcar tudo",
        "none_selected":"Nenhuma linha selecionada.",
    }
else:
    T = {
