...
en: {
  ...
  spot_h: "🎨 Featured: Folder Color Revival — infinite colors + image overlays",
  spot_p: 'The classic folder colorizer, revived for modern Nautilus — now with <strong>infinite custom colors</strong> powered by an embedded <a href="https://github.com/zonaro/NameToColor">NameToColor</a> engine (2254 named colors + pt-BR, deterministic hash for any word) and <strong>image overlays</strong> stamped right onto the icon.',
  ...
  c17h: "📁 Folder Color Revival", c17p: "Color &amp; emblem tagging + infinite custom colors + image overlays + Dolphin import.",
  c18h: "👁️ Hidden Dim", c18p: "Dim hidden files' icons (or icon+label).",
  c19h: "🧹 Remove AI Watermarks", c19p: "Strip invisible AI watermarks from images via CLI.",
...
fr: {
  ...
  spot_h: "🎨 En vedette : Folder Color Revival — couleurs infinies + superpositions d'images",
  spot_p: 'Le colorateur de dossiers classique, relancé pour Nautilus moderne — avec des <strong>couleurs personnalisées infinies</strong> grâce au moteur <a href="https://github.com/zonaro/NameToColor">NameToColor</a> intégré (2254 couleurs nommées + pt-BR, hachage déterministe pour tout mot) et des <strong>superpositions d\'images</strong> appliquées directement sur l\'icône.',
  ...
  c17h: "📁 Folder Color Revival", c17p: "Étiquetage couleur &amp; emblèmes + couleurs infinies + superpositions d'images + import Dolphin.",
  c18h: "👁️ Atténuer cachés", c18p: "Atténue les icônes (ou icône+label) des fichiers cachés.",
  c19h: "🧹 Remove AI Watermarks", c19p: "Supprime les filigranes IA invisibles des images via CLI.",
...
de: {
  ...
  spot_h: "🎨 Highlight: Folder Color Revival — unendliche Farben + Bild-Overlays",
  spot_p: 'Der klassische Ordnerfärber, neu aufgelegt für modernes Nautilus — mit <strong>unendlichen benutzerdefinierten Farben</strong> dank eingebauter <a href="https://github.com/zonaro/NameToColor">NameToColor</a>-Engine (2254 benannte Farben + pt-BR, deterministischer Hash für jedes Wort) und <strong>Bild-Overlays</strong>, die direkt auf das Symbol gestempelt werden.',
  ...
  c17h: "📁 Folder Color Revival", c17p: "Farb- &amp; Emblem-Markierung + unendliche Farben + Bild-Overlays + Dolphin-Import.",
  c18h: "👁️ Versteckt dimmen", c18p: "Dimmt Symbole (oder Symbol+Label) versteckter Dateien.",
  c19h: "🧹 Remove AI Watermarks", c19p: "Entfernt unsichtbare KI-Wasserzeichen aus Bildern per CLI.",
...
"pt-BR": {
  ...
  spot_h: "🎨 Destaque: Folder Color Revival — cores infinitas + sobreposições de imagem",
  spot_p: 'O clássico coloridor de pastas, revivido para o Nautilus moderno — agora com <strong>cores personalizadas infinitas</strong> graças ao motor <a href="https://github.com/zonaro/NameToColor">NameToColor</a> embutido (2254 cores nomeadas + pt-BR, hash determinístico para qualquer palavra) e <strong>sobreposições de imagem</strong> carimbadas direto no ícone.',
  ...
  c17h: "📁 Folder Color Revival", c17p: "Marcação por cor e emblemas + cores infinitas + sobreposições de imagem + importação Dolphin.",
  c18h: "👁️ Escurecer ocultos", c18p: "Escurece ícones (ou ícone+rótulo) de arquivos ocultos.",
  c19h: "🧹 Remove AI Watermarks", c19p: "Remove marcas d'água de IA invisíveis das imagens via CLI.",
...
es: {
  ...
  spot_h: "🎨 Destacado: Folder Color Revival — colores infinitos + superposiciones de imagen",
  spot_p: 'El clásico coloreador de carpetas, revivido para Nautilus moderno — ahora con <strong>colores personalizados infinitos</strong> gracias al motor <a href="https://github.com/zonaro/NameToColor">NameToColor</a> integrado (2254 colores con nombre + pt-BR, hash determinista para cualquier palabra) y <strong>superposiciones de imagen</strong> estampadas directamente sobre el icono.',
  ...
  c17h: "📁 Folder Color Revival", c17p: "Marcado por color y emblemas + colores infinitos + superposiciones de imagen + importación Dolphin.",
  c18h: "👁️ Atenuar ocultos", c18p: "Atenúa iconos (o icono+etiqueta) de archivos ocultos.",
  c19h: "🧹 Remove AI Watermarks", c19p: "Elimina marcas de agua IA invisibles de imágenes vía CLI.",
