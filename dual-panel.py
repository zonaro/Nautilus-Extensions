...
if _lang.startswith("de"):
    ...
    T = {
        "menu_label":    "Abrir en panel doble",
        "title":         "Panel doble",
        "copy":          "Copiar →",
        "copy_left":     "← Copiar",
        "move":          "Mover →",
        ...
        "col_date":      "Modificado",
        "col_perms":     "Permisos",
        "confirm_del":   "¿Eliminar {name}?",
        "confirm_del2":  "¿Eliminar {n} elementos?",
        "confirm_move":  "¿Mover {name} a {dst}?",
        "confirm_move2": "¿Mover {n} elementos a {dst}?",
        "err_title":     "Error",
        "new_folder_name": "Nueva carpeta",
        "new_file_name":   "nuevo_archivo.txt",
        "enter_name":    "Nombre:",
        "cancel":        "Cancelar",
        "ok":            "Aceptar",
        "delete_ok":     "Eliminar",
        "open_terminal":  "Terminal aquí",
        "sidebar_favorites": "Favoritos",
        "toast_copy_done":  "Copia terminada",
        "toast_move_done":  "Traslado terminado",
        "toast_error":      "Error: {msg}",
        "sidebar_trash":     "Papelera",
        "sidebar_bookmarks": "Marcadores",
        "sidebar_places":    "Lugares",
        "delete_perm":   "Eliminar definitivamente",
        "confirm_perm":  "¿Eliminar DEFINITIVAMENTE {name}? ¡No se puede deshacer!",
        "confirm_perm2": "¿Eliminar DEFINITIVAMENTE {n} elementos? ¡No se puede deshacer!",
        "context_open":        "Abrir",
        "context_copy":        "Copiar al otro panel",
        "context_move":        "Mover al otro panel",
        "context_rename":      "Renombrar",
        "context_delete":      "Mover a la papelera",
        "context_delete_perm": "Eliminar definitivamente",
        "context_new_folder":  "Nueva carpeta",
        "context_new_file":    "Nuevo archivo",
        "context_terminal":    "Terminal aquí",
        "context_extract_audio": "Extraer audio",
        "context_extract_here": "Extraer aquí",
    }
elif _lang.startswith("pt"):
    T = {
        "menu_label":    "Abrir em painel duplo",
        "title":         "Painel Duplo",
        "copy":          "Copiar →",
        "copy_left":     "← Copiar",
        "move":          "Mover →",
        ...
        "confirm_del":   "Excluir {name}?",
        "confirm_del2":  "Excluir {n} itens?",
        "confirm_move":  "Mover {name} para {dst}?",
        "confirm_move2": "Mover {n} itens para {dst}?",
        "err_title":     "Erro",
        ...
        "ok":            "OK",
        "delete_ok":     "Excluir",
        "open_terminal":  "Terminal aqui",
        "sidebar_favorites": "Favoritos",
        "toast_copy_done":  "Cópia concluída",
        "toast_move_done":  "Movimentação concluída",
        "toast_error":      "Erro: {msg}",
        "sidebar_trash":     "Lixeira",
        "sidebar_bookmarks": "Favoritos",
        "sidebar_places":    "Locais",
        "delete_perm":   "Excluir definitivamente",
        "confirm_perm":  "Excluir DEFINITIVAMENTE {name}? Não tem volta!",
        "confirm_perm2": "Excluir DEFINITIVAMENTE {n} itens? Não tem volta!",
        "context_open":        "Abrir",
        "context_copy":        "Copiar para o outro painel",
        "context_move":        "Mover para o outro painel",
        "context_rename":      "Renomear",
        "context_delete":      "Mover para a lixeira",
        "context_delete_perm": "Excluir definitivamente",
        "context_new_folder":  "Nova pasta",
        "context_new_file":    "Novo arquivo",
        "context_terminal":    "Terminal aqui",
        "context_extract_audio": "Extrair áudio",
        "context_extract_here": "Extrair aqui",
    }
else:
    T = {
